...
/**
 * Main Elementor Pr-dropdown Class
 *
 * The init class that runs the Elementor Pr-dropdown plugin.
 ...
 */
final class Elementor_Prdropdown {
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-prdopdown' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_PRDROPDOWN ) );
